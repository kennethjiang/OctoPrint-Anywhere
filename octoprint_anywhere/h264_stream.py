...
class H264Streamer:
    ...
    def start_hls_pipeline(self, remote_status, plugin, dev_settings):
        ...
        ffmpeg_cmd = '{} -re -i pipe:0 -y -an -vcodec copy -f hls -hls_time 10 -hls_list_size 10 -hls_delete_threshold 10 -hls_flags split_by_time+delete_segments+second_level_segment_index -strftime 1 -hls_segment_filename {}/%%d.ts -hls_segment_type mpegts -'.format(FFMPEG, TS_TEMP_DIR)
